...
set(SISO_SDKLIN_DIR "${CMAKE_CURRENT_SOURCE_DIR}/sdkSisoLin" CACHE PATH "location of SISO Linux SDK")
...
if(WIN32)
  ...
  set(SISO_DIR "${SISO_SDKLIN_DIR}" CACHE PATH "SISO BASE DIR")
  set(SISO_LIB_DIR "${SISO_SDKLIN_DIR}/lib" CACHE PATH "SISO LIB DIR")
